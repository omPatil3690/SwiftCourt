...
if (missing.length) {
    ...
    console.error(`ACCESS_TOKEN_SECRET=${crypto_1.default.randomBytes(32).toString('hex')}`);
    console.error(`REFRESH_TOKEN_SECRET=${crypto_1.default.randomBytes(32).toString('hex')}`);
...
exports.env = {
    ...
    corsOrigin: process.env.NODE_ENV === 'development'
        ...
        : (((_a = process.env.CORS_ORIGIN) === null || _a === void 0 ? void 0 : _a.split(',')) || ['http://localhost:3000']),
